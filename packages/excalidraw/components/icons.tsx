...
export const createIcon = (d: string | React.ReactNode, opts: number | Opts = 512,) => {
  const {width = 512,height = width,mirror,style,...rest} = typeof opts === "number" ? ({ width: opts } as Opts) : opts;
  return (
    <svg
      aria-hidden="true"
      focusable="false"
...
/*--myca--*/
// Image Crop Icon
export const ImageCropIcon = createIcon(
  <g strokeWidth="1.25" strokeLinecap="square" strokeLinejoin="round">
    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    <path d="M3 3 h18 v18 h-18 z" strokeWidth="2" strokeDasharray="1,4"></path>
    <path d="M5 12 v7 h7 v4 h-11 v-11 z" fill="white"></path>
    <path d="M12 5 h7 v7 h4 v-11 h-11 z" fill="white"></path>
  </g>,
  tablerIconProps,
);

// Path Icon
export const PathIcon = <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M760-120q-39 0-70-22.5T647-200H440q-66 0-113-47t-47-113q0-66 47-113t113-47h80q33 0 56.5-23.5T600-600q0-33-23.5-56.5T520-680H313q-13 35-43.5 57.5T200-600q-50 0-85-35t-35-85q0-50 35-85t85-35q39 0 69.5 22.5T313-760h207q66 0 113 47t47 113q0 66-47 113t-113 47h-80q-33 0-56.5 23.5T360-360q0 33 23.5 56.5T440-280h207q13-35 43.5-57.5T760-360q50 0 85 35t35 85q0 50-35 85t-85 35ZM200-680q17 0 28.5-11.5T240-720q0-17-11.5-28.5T200-760q-17 0-28.5 11.5T160-720q0 17 11.5 28.5T200-680Z"/></svg>;

// Clipping Mask Icon
export const ClippingMaskIcon = <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56.3636474609375 54.54547119140625" width="28px" height="28px"><g strokeLinecap="round" transform="translate(10 10) rotate(0 18.18182373046875 12.337668282645097)"><path d="M6.17 0 C14.92 0, 23.66 0, 30.19 0 C34.31 0, 36.36 2.06, 36.36 6.17 C36.36 9.08, 36.36 11.98, 36.36 18.51 C36.36 22.62, 34.31 24.68, 30.19 24.68 C22.59 24.68, 14.98 24.68, 6.17 24.68 C2.06 24.68, 0 22.62, 0 18.51 C0 15.55, 0 12.6, 0 6.17 C0 2.06, 2.06 0, 6.17 0" stroke="black" strokeWidth="4" fill="#ffffff"></path></g><g strokeLinecap="round" transform="translate(17.272729492187523 19.87013462611617) rotate(0 10.909094238281227 12.337668282645097)"><path d="M21.82 12.34 C21.82 13.05, 21.76 13.78, 21.65 14.48 C21.54 15.18, 21.38 15.89, 21.16 16.56 C20.94 17.23, 20.67 17.89, 20.36 18.51 C20.04 19.12, 19.67 19.72, 19.27 20.27 C18.86 20.82, 18.41 21.33, 17.92 21.79 C17.44 22.25, 16.91 22.67, 16.36 23.02 C15.82 23.38, 15.23 23.69, 14.64 23.93 C14.05 24.18, 13.43 24.36, 12.8 24.49 C12.18 24.61, 11.54 24.68, 10.91 24.68 C10.28 24.68, 9.64 24.61, 9.01 24.49 C8.39 24.36, 7.77 24.18, 7.18 23.93 C6.58 23.69, 6 23.38, 5.45 23.02 C4.91 22.67, 4.38 22.25, 3.9 21.79 C3.41 21.33, 2.96 20.82, 2.55 20.27 C2.15 19.72, 1.78 19.12, 1.46 18.51 C1.15 17.89, 0.87 17.23, 0.66 16.56 C0.44 15.89, 0.28 15.18, 0.17 14.48 C0.06 13.78, 0 13.05, 0 12.34 C0 11.62, 0.06 10.9, 0.17 10.2 C0.28 9.49, 0.44 8.79, 0.66 8.12 C0.87 7.45, 1.15 6.79, 1.46 6.17 C1.78 5.55, 2.15 4.95, 2.55 4.41 C2.96 3.86, 3.41 3.35, 3.9 2.89 C4.38 2.43, 4.91 2.01, 5.45 1.65 C6 1.3, 6.58 0.99, 7.18 0.74 C7.77 0.5, 8.39 0.31, 9.01 0.19 C9.64 0.06, 10.28 0, 10.91 0 C11.54 0, 12.18 0.06, 12.8 0.19 C13.43 0.31, 14.05 0.5, 14.64 0.74 C15.23 0.99, 15.82 1.3, 16.36 1.65 C16.91 2.01, 17.44 2.43, 17.92 2.89 C18.41 3.35, 18.86 3.86, 19.27 4.41 C19.67 4.95, 20.04 5.55, 20.36 6.17 C20.67 6.79, 20.94 7.45, 21.16 8.12 C21.38 8.79, 21.54 9.49, 21.65 10.2 C21.76 10.9, 21.79 11.98, 21.82 12.34 C21.85 12.69, 21.85 11.98, 21.82 12.34" stroke="black" strokeWidth="4" fill="#ffffff"></path></g></svg>;

// Release Clipping Mask Icon
export const ReleaseClippingMask = <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56.3636474609375 54.54547119140625" width="28px" height="28px"><g strokeLinecap="round" transform="translate(10 10) rotate(0 18.18182373046875 12.337668282645097)"><path d="M6.17 0 C14.92 0, 23.66 0, 30.19 0 C34.31 0, 36.36 2.06, 36.36 6.17 C36.36 9.08, 36.36 11.98, 36.36 18.51 C36.36 22.62, 34.31 24.68, 30.19 24.68 C22.59 24.68, 14.98 24.68, 6.17 24.68 C2.06 24.68, 0 22.62, 0 18.51 C0 15.55, 0 12.6, 0 6.17 C0 2.06, 2.06 0, 6.17 0" stroke="black" strokeWidth="4" fill="#ffffff"></path></g><g strokeLinecap="round" transform="translate(17.272729492187523 19.87013462611617) rotate(0 10.909094238281227 12.337668282645097)"><path d="M21.82 12.34 C21.82 13.05, 21.76 13.78, 21.65 14.48 C21.54 15.18, 21.38 15.89, 21.16 16.56 C20.94 17.23, 20.67 17.89, 20.36 18.51 C20.04 19.12, 19.67 19.72, 19.27 20.27 C18.86 20.82, 18.41 21.33, 17.92 21.79 C17.44 22.25, 16.91 22.67, 16.36 23.02 C15.82 23.38, 15.23 23.69, 14.64 23.93 C14.05 24.18, 13.43 24.36, 12.8 24.49 C12.18 24.61, 11.54 24.68, 10.91 24.68 C10.28 24.68, 9.64 24.61, 9.01 24.49 C8.39 24.36, 7.77 24.18, 7.18 23.93 C6.58 23.69, 6 23.38, 5.45 23.02 C4.91 22.67, 4.38 22.25, 3.9 21.79 C3.41 21.33, 2.96 20.82, 2.55 20.27 C2.15 19.72, 1.78 19.12, 1.46 18.51 C1.15 17.89, 0.87 17.23, 0.66 16.56 C0.44 15.89, 0.28 15.18, 0.17 14.48 C0.06 13.78, 0 13.05, 0 12.34 C0 11.62, 0.06 10.9, 0.17 10.2 C0.28 9.49, 0.44 8.79, 0.66 8.12 C0.87 7.45, 1.15 6.79, 1.46 6.17 C1.78 5.55, 2.15 4.95, 2.55 4.41 C2.96 3.86, 3.41 3.35, 3.9 2.89 C4.38 2.43, 4.91 2.01, 5.45 1.65 C6 1.3, 6.58 0.99, 7.18 0.74 C7.77 0.5, 8.39 0.31, 9.01 0.19 C9.64 0.06, 10.28 0, 10.91 0 C11.54 0, 12.18 0.06, 12.8 0.19 C13.43 0.31, 14.05 0.5, 14.64 0.74 C15.23 0.99, 15.82 1.3, 16.36 1.65 C16.91 2.01, 17.44 2.43, 17.92 2.89 C18.41 3.35, 18.86 3.86, 19.27 4.41 C19.67 4.95, 20.04 5.55, 20.36 6.17 C20.67 6.79, 20.94 7.45, 21.16 8.12 C21.38 8.79, 21.54 9.49, 21.65 10.2 C21.76 10.9, 21.79 11.98, 21.82 12.34 C21.85 12.69, 21.85 11.98, 21.82 12.34" stroke="none" strokeWidth="4" fill="none"></path></g></svg>;
/*--myca--*/
